...
city_paths = {
    "Bay Area": {
        "mzn_path": "~/Downloads/h3_bay_8.geojson",
        "flows_path": "~/Downloads/bay_flows_h3_8.csv"
    },
    "Los Angeles": {
        "mzn_path": "~/Downloads/h3_la_8.geojson",
        "flows_path": "~/Downloads/la_flows_h3_8.csv"
    },
    "Mexico City": {
        "mzn_path": "~/Downloads/h3_cdmx_8.geojson",
        "flows_path": "~/Downloads/cdmx_flows_h3_8.csv"
    },
    "Rio de Janeiro": {
        "mzn_path": "/data/Berkeley/BR/maps/map_informality_eci.geojson",
        "flows_path": "~/Downloads/rio_flows_h3_8h3.csv"
    }
}
...
fig.savefig("../figs_paper/model_performance.pdf", dpi=300, bbox_inches="tight")
plt.tight_layout()
plt.show()
```
...
accessibility_fig.savefig('../figs_paper/accessibility_boxplots_sharey.pdf', dpi=300,
...
maps_fig.savefig('../figs_paper/maps_hist.pdf', dpi=300,
                 facecolor='white', edgecolor='none')
maps_fig.savefig('../figs_paper/maps_hist.png', dpi=300, bbox_inches='tight',
                 facecolor='white', edgecolor='none')
plt.show()
```
...
fig.savefig('../figs_paper/accessibility_maps_space.pdf', dpi=300,
            facecolor='white', edgecolor='none')
fig.savefig('../figs_paper/accessibility_maps_space.png', dpi=300, bbox_inches='tight',
            facecolor='white', edgecolor='none')
plt.show()
```
...
```{python}
try:
    ipath = "/home/ollin/Dropbox/enlace_hacia_documentos/Berkeley/informalidad/figs"
    ...
    fig.savefig("../figs_paper/four_panel_layout_workreach_font.pdf", dpi=300, bbox_inches="tight")
    plt.show()
