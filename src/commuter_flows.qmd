...
This following code only creates a figure layout from previously created plots.
The original files are created in [this notebook](workreach_fig/workreach_abstract_fig.qmd)
